...
class _$_SpacingInsetsData implements _SpacingInsetsData {
  const _$_SpacingInsetsData(
      ...
      : assert(all != null),
        ...
        assert(onlyRight != null),
        assert(onlyTop != null),
        assert(onlyBottom != null),
        assert(onlyLeft != null),
        assert(exceptLeft != null),
        assert(exceptRight != null),
        assert(exceptTop != null),
        assert(exceptBottom != null);
